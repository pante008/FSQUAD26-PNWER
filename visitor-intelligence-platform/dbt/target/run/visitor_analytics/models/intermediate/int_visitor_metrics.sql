...
create or replace transient table VISITORS_DB.STAGING_INTERMEDIATE.int_visitor_metrics
    
    
    
    as (-- Intermediate layer: Calculate metrics
...
from VISITORS_DB.STAGING_STAGING.stg_visitors
    )
;
